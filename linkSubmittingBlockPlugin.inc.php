...
class linkSubmittingBlockPlugin extends BlockPlugin {
	 ...
	 */
	function getName() {
		return 'linkSubmittingBlockPlugin';
	}
	...
	function getDisplayName() {
		return Locale::translate('plugins.block.linkSubmitting.displayName');
	}
	...
	function getDescription() {
		return Locale::translate('plugins.block.linkSubmitting.description');
	}
}
